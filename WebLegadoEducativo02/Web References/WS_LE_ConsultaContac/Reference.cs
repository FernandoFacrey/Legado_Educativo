...
namespace WebLegadoEducativo02.WS_LE_ConsultaContac {
    ...
    public partial class WS_LE_ConsultaContac : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ConsultaContactGuidOperationCompleted;
        ...
        /// <remarks/>
        public event ConsultaContactGuidCompletedEventHandler ConsultaContactGuidCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/ConsultaContactGuid", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Recuperacontact[] ConsultaContactGuid(string guidContact) {
            object[] results = this.Invoke("ConsultaContactGuid", new object[] {
                        guidContact});
            return ((Recuperacontact[])(results[0]));
        }
        
        /// <remarks/>
        public void ConsultaContactGuidAsync(string guidContact) {
            this.ConsultaContactGuidAsync(guidContact, null);
        }
        
        /// <remarks/>
        public void ConsultaContactGuidAsync(string guidContact, object userState) {
            if ((this.ConsultaContactGuidOperationCompleted == null)) {
                this.ConsultaContactGuidOperationCompleted = new System.Threading.SendOrPostCallback(this.OnConsultaContactGuidOperationCompleted);
            }
            this.InvokeAsync("ConsultaContactGuid", new object[] {
                        guidContact}, this.ConsultaContactGuidOperationCompleted, userState);
        }
        
        private void OnConsultaContactGuidOperationCompleted(object arg) {
            if ((this.ConsultaContactGuidCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ConsultaContactGuidCompleted(this, new ConsultaContactGuidCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void ConsultaContactGuidCompletedEventHandler(object sender, ConsultaContactGuidCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ConsultaContactGuidCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ConsultaContactGuidCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
