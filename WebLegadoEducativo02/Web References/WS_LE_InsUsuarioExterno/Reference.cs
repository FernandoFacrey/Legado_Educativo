...
namespace WebLegadoEducativo02.WS_LE_InsUsuarioExterno {
    ...
    public partial class WS_LE_InsUsuarioExterno : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Respuesta InsUsuarioExt(string recr_contactoid, string recr_clientepotencial, string recr_contraseniahash, string recr_correo, string recr_name, string recr_sal, string direccion) {
            object[] results = this.Invoke("InsUsuarioExt", new object[] {
                        recr_contactoid,
                        recr_clientepotencial,
        ...
        /// <remarks/>
        public void InsUsuarioExtAsync(string recr_contactoid, string recr_clientepotencial, string recr_contraseniahash, string recr_correo, string recr_name, string recr_sal, string direccion) {
            this.InsUsuarioExtAsync(recr_contactoid, recr_clientepotencial, recr_contraseniahash, recr_correo, recr_name, recr_sal, direccion, null);
        }
        
        /// <remarks/>
        public void InsUsuarioExtAsync(string recr_contactoid, string recr_clientepotencial, string recr_contraseniahash, string recr_correo, string recr_name, string recr_sal, string direccion, object userState) {
